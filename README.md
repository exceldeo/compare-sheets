...
![usage](./screenshoot/usage.png)
    ...
    2. Select the sheet you want to compare.
        a. You can compare the current sheet against another sheet in the difference spreadsheet with enter url and fetch data.
...
![image-5](./screenshoot/image-5.png)
![image-6](./screenshoot/image-6.png)
